...
from reconstruct.scheduler import get_schedule_jump
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
            self, model, x, t, x_start, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
        ...
        model_output = model(x, self._scale_timesteps(t), x_start, **model_kwargs)
