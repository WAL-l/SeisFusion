...
class SuperResModel(UNetModel):
    ...
    def __init__(self, data_size, in_channels, *args, **kwargs):
        super().__init__(data_size, in_channels * 2, *args, **kwargs)
    ...
    def __init__(
        ...
        if pool == "adaptive":
            ...
            self.out = nn.Sequential(
                ...
                nn.SiLU(),
                AttentionPool2d(
                    (data_size // ds), ch, num_head_channels, out_channels
                ),
            )
        elif pool == "spatial":
            self.out = nn.Sequential(
...
class condition_U(nn.Module):
    ...
    def forward(self, x, t, condition, y=None, gt=None, **kwargs):
        t1 = self.model1(x, t, y, gt, )
        t2 = self.model2(condition, t, y, gt, )
